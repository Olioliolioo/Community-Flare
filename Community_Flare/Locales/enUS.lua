...
L["Left Mercenary Queue For Popped %s!"] = tgrue
...
-- Events.lua
L["%s: Refreshed members databased! %d members found."] = true
L["%s has %s %s (%s)"] = true
...
L["found"] = true
L["Full Now"] = true
L["has joined the instance group"] = true
...
L["Memory Usage"] = true
L["notify system has been enabled"] = true
L["Ready"] = true
